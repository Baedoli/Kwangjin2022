--------------------------------------------------------
--  DDL for Package Body KB2B3107
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KB2B3107" 
IS
  PROCEDURE control
  (
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('팔레트 번호')||'", "80","center","ro","str","true"];i++;
            x[i]=["'||get_fn('팔레트명')||'", "240","left","ro","str","true"];i++;
            x[i]=["'||get_fn('Total')||'", "130","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
