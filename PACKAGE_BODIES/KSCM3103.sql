--------------------------------------------------------
--  DDL for Package Body KSCM3103
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM3103" 
IS
  PROCEDURE control
  (
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('거래처명')||'", "*","center","ro","str","true"];i++;
  ...
  IS
    cursor cur is
      select 'kwang' as gubun from dual
      union
      select 'pana' as gubun from dual
      union
      select 'ajin' as gubun from dual
      ;
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["NO", "40","center","ro","int","true"];i++;
            x[i]=["'||get_fn('소요자재')||'", "150","center","ro","str","true"];i++;
            x[i]=["'||get_fn('소요자재명')||'", "*","left","ro","str","true"];i++;
            x[i]=["'||get_fn('소요수량')||'", "100","right","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
