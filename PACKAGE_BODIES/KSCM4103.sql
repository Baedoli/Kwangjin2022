--------------------------------------------------------
--  DDL for Package Body KSCM4103
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM4103" 
IS
  PROCEDURE control
  (
  ...
  <div id="top-header" style="padding-bottom: 2px;background-color: #ffffff;">
    ...
    <div id="c00">
      <div id="c01">
        ...
        <div class="cBox">
          <div class="cTitle"><label for="p_yy">'||get_fn('일자')||'</label></div>
          <div class="cInput">
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('품번')||'", "100","left","ro","str","true"];i++;
            x[i]=["'||get_fn('품명')||'", "*","left","ro","str","true"];i++;
            x[i]=["'||get_fn('발주량')||'", "80","left","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('가입고대기')||'", "80","left","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('검수대기')||'", "80","left","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('입고수량')||'", "80","left","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('불량수량')||'", "80","left","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('반품수량')||'", "80","left","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('합격수량')||'", "80","left","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
