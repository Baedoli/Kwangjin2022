--------------------------------------------------------
--  DDL for Package Body KB2B1110
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KB2B1110" 
IS
  PROCEDURE control
  (
  ...
  <div id="top-header" style="padding-bottom: 2px;background-color: #ffffff;">
    ...
    <div id="c00">
      <div id="c01">
        ...
        <div class="cBox">
          <div class="cTitle"><label for="p_symd">'||get_fn('등록기간')||'</label></div>
          <div class="cInput">
        ...
        <div class="cBox">
          <div class="cTitle"><label for="p_companycd">'||get_fn('도착사업장')||'</label></div>
          <div class="cInput">
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('출고일자')||'", "70","center","ro","str","true"];i++;
            x[i]=["'||get_fn('컨테이너 번호')||'", "100","center","ro","str","true"];i++;
            x[i]=["'||get_fn('총 수량')||'", "60","left","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('총 금액(외화)')||'", "*","left","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('ASN(개발중)')||'", "80","left","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
  ...
  IS
    ...
    cursor cur is
      select '20221123' as sdate
            ,'4270-2335' as conno
            ,'REG ASSY-PR LH' as qty
            ,'3560' as summoney
            ,'5500' as asn
      from dual
      ;
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('판매 품번')||'", "150","center","ro","str","true"];i++;
            x[i]=["'||get_fn('판매 품명')||'", "*","left","ro","str","true"];i++;
            x[i]=["'||get_fn('운송 수량')||'", "100","left","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('금액(외화)')||'", "*","left","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
