--------------------------------------------------------
--  DDL for Package Body KB2B1107
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KB2B1107" 
IS
  PROCEDURE control
  (
  ...
  <div id="top-header" style="padding-bottom: 2px;background-color: #ffffff;">
    ...
    <div id="c00">
      ...
      <div class="cBox">
        <div class="cTitle"><label for="p_symd">'||get_fn('일자 Bucket')||'</label></div>
        <div class="cInput">
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('포장일자')||'", "100","center","ro","str","true"];i++;
            x[i]=["'||get_fn('컨테이너 번호')||'", "100","left","ro","str","true"];i++;
            x[i]=["'||get_fn('출발사업장')||'", "180","left","ro","str","true"];i++;
            x[i]=["'||get_fn('도착사업장')||'", "100","left","ro","str","true"];i++;
            x[i]=["'||get_fn('출발일자')||'", "80","left","ro","str","true"];i++;
            x[i]=["'||get_fn('비고')||'", "*","left","ro","str","true"];i++;
  ...
  IS
    cursor cur is
      select '221126' as podate
            ,'76570-2335' as contno
            ,'busan' as scomp
            ,'ulsan' as ecomp
            ,'221128' as symd
            ,'2115' as notes
