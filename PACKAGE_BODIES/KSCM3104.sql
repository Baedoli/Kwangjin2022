--------------------------------------------------------
--  DDL for Package Body KSCM3104
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM3104" 
IS
  PROCEDURE control
  (
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["NO", "40","center","ro","int","true"];i++;
            x[i]=["'||get_fn('소요품번')||'", "150","center","ro","str","true"];i++;
            x[i]=["'||get_fn('소요품명')||'", "*","left","ro","str","true"];i++;
