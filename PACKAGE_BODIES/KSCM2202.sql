--------------------------------------------------------
--  DDL for Package Body KSCM2202
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM2202" 
IS
  PROCEDURE control
  (
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('대표품명')||'", "200","left","ro","str","true"];i++;
            x[i]=["'||get_fn('자재품번')||'", "120","center","ro","str","true"];i++;
            x[i]=["'||get_fn('자재품명')||'", "200","left","ro","str","true"];i++;
            x[i]=["'||get_fn('단가')||'", "140","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('수량')||'", "140","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('금액')||'", "180","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
