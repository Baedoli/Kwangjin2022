--------------------------------------------------------
--  DDL for Package Body KSCM6102
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM6102" 
IS
  PROCEDURE control
  (
  ...
  IS
    cursor cur is
      select 'linename41' as gubun from dual
      union
      select 'linename71' as gubun from dual
      union
      select 'linename63' as gubun from dual
      ;
