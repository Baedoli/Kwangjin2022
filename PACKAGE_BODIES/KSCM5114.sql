--------------------------------------------------------
--  DDL for Package Body KSCM5114
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM5114" 
IS
  PROCEDURE control
  (
  ...
  <div id="top-header" style="padding-bottom: 2px;background-color: #ffffff;">
    ...
    <div id="c00">
      <div id="c01">
        ...
        <div class="cBox">
          <div class="cTitle"><label for="p_yy">'||get_fn('기준일')||'</label></div>
          <div class="cInput">
