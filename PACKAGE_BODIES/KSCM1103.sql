--------------------------------------------------------
--  DDL for Package Body KSCM1103
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM1103" 
IS
  PROCEDURE control
  (
  ...
  <div id="top-header" style="padding-bottom: 2px;background-color: #ffffff;">
    ...
    <div id="c00">
      <div id="c01">
        ...
        <div class="cBox">
          <div class="cTitle"><label for="p_ymd">'||get_fn('기준일자')||'</label></div>
          <div class="cInput">
            <input type="text" id="p_ymd" name="p_ymd" value="'||p_ymd||'" class="cDate">
          </div>
        </div>
        <div class="cBox">
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('사업구분')||'", "*","center","ro","str","true"];i++;
  ...
  IS
    cursor cur is
      select 'test' as gubun from dual
      ;
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["NO", "40","center","ro","int","true"];i++;
            x[i]=["'||get_fn('차종')||'", "80","center","ro","str","true"];i++;
            x[i]=["'||get_fn('대표품번')||'", "100","center","ro","str","true"];i++;
            x[i]=["'||get_fn('품명')||'", "150","left","ro","str","true"];i++;
            x[i]=["'||get_fn('당일')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('+1')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('+2')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('+3')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('+4')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('+5')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('+6')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('+7')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('+8')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('+9')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('+10')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('+11')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('+12')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('+13')||'", "70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
