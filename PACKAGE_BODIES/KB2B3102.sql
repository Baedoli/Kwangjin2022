--------------------------------------------------------
--  DDL for Package Body KB2B3102
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KB2B3102" 
IS
  PROCEDURE control
  (
  ...
  <div id="top-header" style="padding-bottom: 2px;background-color: #ffffff;">
    ...
    <div id="c00">
      <div id="c01">
        ...
        <div class="cBox">
          <div class="cTitle"><label for="p_companycd">'||get_fn('출발')||'</label></div>
          <div class="cInput">
        ...
        <div class="cBox">
          <div class="cTitle"><label for="p_ecompanycd">'||get_fn('도착')||'</label></div>
          <div class="cInput">
            <select name="p_ecompanycd" id="p_ecompanycd">
            '); common.list_company(p_ecompanycd, v_lang); htp.p('
            </select>
          </div>
        </div>
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('차종명')||'", "100","center","ro","str","true"];i++;
            x[i]=["'||get_fn('품번')||'", "140","center","ro","str","true"];i++;
            x[i]=["'||get_fn('품명')||'", "240","left","ro","str","true"];i++;
            x[i]=["'||get_fn('Total')||'", "80","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
  ...
  IS
    cursor cur is
      select 'cn7' as kindnm
            ,'12412-11541' as partno
            ,'avang' as partnm
            ,'598481' as tatal
      from dual
      ;
