--------------------------------------------------------
--  DDL for Package Body KSCM6101
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM6101" 
IS
  PROCEDURE control
  (
  ...
  IS
    cursor cur is
      select 'linename' as gubun from dual
      union
      select 'linename3' as gubun from dual
      union
      select 'linename6' as gubun from dual
      ;
