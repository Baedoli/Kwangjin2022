--------------------------------------------------------
--  DDL for Package Body KSCM2201
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM2201" 
IS
  PROCEDURE control
  (
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn(i||'월')||'", "100","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;     
            '); end loop;  htp.p('
