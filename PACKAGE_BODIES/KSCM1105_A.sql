--------------------------------------------------------
--  DDL for Package Body KSCM1105_A
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM1105_A" 
IS
  PROCEDURE control
  (
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('라인명')||'", "*","center","ro","str","true"];i++;
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["NO", "40","center","ro","int","true"];i++;
            x[i]=["'||get_fn('라인명')||'","100","center","ro","str","true"];i++;
            x[i]=["'||get_fn('대표품번')||'","100","center","ro","str","true"];i++;
            x[i]=["'||get_fn('품명')||'","160","left","ro","str","true"];i++;
            x[i]=["'||get_fn('사업구분')||'","60","center","ro","str","true"];i++;
            x[i]=["'||get_fn('수량')||'","70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('Q1')||'","70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('Q2')||'","70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('Q3')||'","70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('Q4')||'","70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('Q5')||'","70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('Q6')||'","70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('Q7')||'","70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('Q8')||'","70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('Q9')||'","70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('Q10')||'","70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('용기소요량')||'","70","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
