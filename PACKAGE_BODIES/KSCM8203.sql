--------------------------------------------------------
--  DDL for Package Body KSCM8203
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM8203" 
IS
  PROCEDURE control
  (
  ...
  <div id="top-header" style="padding-bottom: 2px;background-color: #ffffff;">
    ...
    <div id="c00">
      ...
      <div class="cBox">
        <div class="cTitle"><label for="p_yy">'||get_fn('기준년')||'</label></div>
        <div class="cInput">
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('년월')||'", "100","center","ro","str","true"];i++;
            x[i]=["'||get_fn('업체명')||'", "*","center","ro","str","true"];i++;
            x[i]=["'||get_fn('지급금액')||'", "120","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('현금지급액')||'", "120","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('어음지급액')||'", "120","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('만기일')||'", "120","center","ro","str","true"];i++;
