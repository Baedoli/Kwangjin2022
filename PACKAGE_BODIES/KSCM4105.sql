--------------------------------------------------------
--  DDL for Package Body KSCM4105
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM4105" 
IS
  PROCEDURE control
  (
  ...
  IS
    cursor cur is
      select '7' as gubun from dual
      union
      select '8' as gubun from dual
      union
      select '9' as gubun from dual
      ;
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('수량')||'", "120","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
