--------------------------------------------------------
--  DDL for Package Body KSCM3101
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM3101" 
IS
  PROCEDURE control
  (
  ...
  IS
    cursor cur is
      select 'line14' as gubun from dual
      union
      select 'line23' as gubun from dual
      union
      select 'line22' as gubun from dual
      ;
