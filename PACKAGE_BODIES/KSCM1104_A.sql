--------------------------------------------------------
--  DDL for Package Body KSCM1104_A
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM1104_A" 
IS
  PROCEDURE control
  (
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('반')||'", "*","center","ro","str","true"];i++;
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["NO", "40","center","ro","int","true"];i++;
            x[i]=["'||get_fn('라인명')||'", "150","center","ro","str","true"];i++;
            x[i]=["'||get_fn('대표품번')||'", "150","center","ro","str","true"];i++;
            x[i]=["'||get_fn('품명')||'", "200","left","ro","str","true"];i++;
            x[i]=["'||get_fn('주간량')||'", "120","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('야간량')||'", "120","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('계획수량')||'", "120","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
