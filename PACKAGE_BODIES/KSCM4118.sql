--------------------------------------------------------
--  DDL for Package Body KSCM4118
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM4118" 
IS
  PROCEDURE control
  (
  ...
  <head>
    ...
    <script>
      ...
      function doOnLoad() {
        ...
        //myLayout.cells("b").hideHeader();
        myLayout.cells("a").setWidth(1100);
  ...
  <div id="top-header" style="padding-bottom: 2px;background-color: #ffffff;">
    ...
    <div id="c00">
      ...
      <div class="cBox">
        <div class="cTitle"><label for="p_symd">'||get_fn('날짜 기간')||'</label></div>
        <div class="cInput">
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('차종')||'", "*","center","ro","str","true"];i++;
            x[i]=["'||get_fn('품번')||'", "100","center","ro","str","true"];i++;
            x[i]=["'||get_fn('품명')||'", "250","center","ro","str","true"];i++;
            x[i]=["'||get_fn('납품수량')||'", "80","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('불량수량')||'", "80","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('반출수량')||'", "80","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('입고수량')||'", "80","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('반송수량')||'", "80","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["NO", "40","center","ro","int","true"];i++;
            x[i]=["'||get_fn('날짜')||'", "300","center","ro","str","true"];i++;
            x[i]=["'||get_fn('입고수량')||'", "80","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('반송수량')||'", "80","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
