--------------------------------------------------------
--  DDL for Package Body KSCM4113
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM4113" 
IS
  PROCEDURE control
  (
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('품번')||'", "120","center","ro","str","true"];i++;
            x[i]=["'||get_fn('품명')||'", "*","center","ro","str","true"];i++;
  ...
  IS
    cursor cur is
      select '22211-15448' as partno, 'nexo' as partnm from dual
      union
      select '22212-15448' as partno, 'spark' as partnm from dual
      union
      select '22213-15448' as partno, 'sonata' as partnm from dual
      ;
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('발주량')||'", "50","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('가입고대기')||'", "80","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('검수대기')||'", "60","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('입고수량')||'", "60","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('미납량')||'", "60","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('발주번호')||'", "*","center","ro","str","true"];i++;
