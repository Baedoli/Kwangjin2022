--------------------------------------------------------
--  DDL for Package Body WFWAIT_K
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."WFWAIT_K" 
IS
  PROCEDURE list
  (
  ...
  <div id="top-header" style="padding-bottom: 2px;background-color: #ffffff;">
    <form id="form1" name="form1" method="post" action="'||v_pkg||'.list">
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["System", "80","center","ro","str","true"];i++;
            x[i]=["'||get_fn('항목')||'", "120","center","ro","str","true"];i++;
            x[i]=["'||get_fn('내용')||'", "*","center","ro","str","true"];i++;
            x[i]=["'||get_fn('기안자')||'", "100","center","ro","str","true"];i++;
            x[i]=["'||get_fn('기안일')||'", "100","center","ro","str","true"];i++;
            x[i]=["'||get_fn('상태')||'", "200","center","ro","str","true"];i++;
            x[i]=["'||get_fn('결재번호')||'", "80","center","ro","str","true"];i++;
