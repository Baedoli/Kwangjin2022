--------------------------------------------------------
--  DDL for Package Body COMC0030
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."COMC0030" 
IS
  PROCEDURE control
  (
  ...
  <head>
    ...
    <script>
      ...
      function doCrrec() {  
        var url = "'||v_pkg||'.crrec?";  
        newWnd2 = window.open(url,"'||v_pkg||'window","top=100, left=100, status=yes, resizable=no, scrollbars=yes, width=840, height=220");  
        newWnd2.focus();
      } 
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('권한')||'", "200","left","link","str","true"];i++;
            x[i]=["'||get_fn('권한명')||'", "*","left","ro","str","true"];i++;
            x[i]=["'||get_fn('사용여부')||'", "148","center","ro","str","true"];i++;
  ...
  IS
    ...
    cursor cur is
      select  systemcd, grade, descr, useyn
      from    c_0030
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="4">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="titletd require">'||get_fn('권한 코드')||'</td>
                  <td class="inputtd">
                    <input type="text" id="p_grade" name="p_grade" '||v_disabled||' value="'||rec.grade||'" /> 
                  </td>
                </tr>
                <tr>
                  <td class="titletd require">'||get_fn('권한명')||'</td>
                  <td class="inputtd">
  ...
  BEGIN
    ...
    if p_dml_gubun = '1' then
      ...
      begin    
        insert into c_0030 
        (systemcd, grade, descr, useyn)    
        values 
        (p_systemcd, upper(p_grade), p_descr , p_useyn);    
      exception    
      ...
      <script type="text/javascript">
        ...
        location.href = "'||v_pkg||'.crrec?p_systemcd='||p_systemcd||'&p_grade='||upper(p_grade)||'";    
      </script>
      ');
