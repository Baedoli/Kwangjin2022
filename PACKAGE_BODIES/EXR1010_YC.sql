--------------------------------------------------------
--  DDL for Package Body EXR1010_YC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."EXR1010_YC" 
IS
  PROCEDURE control
  (
    ...
    <head>
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            mygrid = parent.myLayout.cells("a").attachGrid();        
          ...
          function doInitGrid2(){
            mygrid2 = parent.myLayout.cells("b").attachGrid();        
            ...
            x[i]=["'||get_fn('목적환율코드')||'", "100","center","ro","str","true"];i++;
            x[i]=["'||get_fn('환율')||'", "70","center","ro","str","true"];i++;
