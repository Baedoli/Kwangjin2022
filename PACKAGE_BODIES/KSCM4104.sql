--------------------------------------------------------
--  DDL for Package Body KSCM4104
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KSCM4104" 
IS
  PROCEDURE control
  (
  ...
  <div id="top-header" style="padding-bottom: 2px;background-color: #ffffff;">
    ...
    <div id="c00">
      ...
      <div class="cBox">
        <div class="cTitle"><label for="p_symd">'||get_fn('기준년월')||'</label></div>
        <div class="cInput">
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('입고구분')||'", "*","center","ro","str","true"];i++;
  ...
  IS
    cursor cur is
      select '3' as gubun from dual
      union
      select '4' as gubun from dual
      union
      select '5' as gubun from dual
      ;
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["NO", "40","center","ro","int","true"];i++;
            x[i]=["'||get_fn('창고')||'", "250","center","ro","str","true"];i++;
            ...
            x[i]=["'||get_fn('반품수량')||'", "80","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
            x[i]=["'||get_fn('합격수량')||'", "80","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
