--------------------------------------------------------
--  DDL for Package Body KB2B3108
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."KB2B3108" 
IS
  PROCEDURE control
  (
      ...
      <title>'||common.title||'</title>
        ...
        <script type="text/javascript">
          ...
          function doInitGrid(){
            ...
            x[i]=["'||get_fn('품번')||'", "140","left","ro","str","true"];i++;
            x[i]=["'||get_fn('품명')||'", "240","left","ro","str","true"];i++;
            x[i]=["'||get_fn('Total')||'", "100","center","ron","int","true"];mygrid.setNumberFormat("0,000", i);i++;
