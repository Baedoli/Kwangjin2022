--------------------------------------------------------
--  DDL for Package Body COMXM607
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PREMIER"."COMXM607" 
IS
  PROCEDURE control
  (
    ...
    <div id="c00">
      <div id="c01">
         ...
         <div class="cBox">
          ...
          <div class="cInput">
          '); common.list_catalog('COM','TEAM_GBN',p_team_gbn,'select', null, 'p_team_gbn', 'a', 'yes'); htp.p('
          </div>
